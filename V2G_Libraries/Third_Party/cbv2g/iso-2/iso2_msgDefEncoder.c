...
static int encode_iso2_DSAKeyValueType(exi_bitstream_t* stream, const struct iso2_DSAKeyValueType* DSAKeyValueType) {
    ...
    while (!done)
    {
        ...
        {
        case 7:
            // Grammar: ID=7; read/write bits=2; START (P), START (G), START (Y)
            if (DSAKeyValueType->P_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (P, base64Binary); next=8
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else if (DSAKeyValueType->G_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (G, base64Binary); next=10
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Y, base64Binary); next=11
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 8:
            // Grammar: ID=8; read/write bits=1; START (Q)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 9:
            // Grammar: ID=9; read/write bits=2; START (G), START (Y)
            ...
            break;
        case 10:
            // Grammar: ID=10; read/write bits=1; START (Y)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 11:
            // Grammar: ID=11; read/write bits=2; START (J), START (Seed), END Element
            if (DSAKeyValueType->J_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (J, base64Binary); next=12
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else if (DSAKeyValueType->Seed_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Seed, base64Binary); next=13
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 12:
            // Grammar: ID=12; read/write bits=2; START (Seed), END Element
            ...
            break;
        case 13:
            // Grammar: ID=13; read/write bits=2; START (PgenCounter), END Element
...
static int encode_iso2_DigestMethodType(exi_bitstream_t* stream, const struct iso2_DigestMethodType* DigestMethodType) {
    ...
    while (!done)
    {
        ...
        case 14:
            ...
            break;
        case 15:
            // Grammar: ID=15; read/write bits=2; START (ANY), END Element, START (ANY)
            // ***** //
            //{
...
static int encode_iso2_TransformsType(exi_bitstream_t* stream, const struct iso2_TransformsType* TransformsType) {
    ...
    while (!done)
    {
        ...
        {
        case 20:
            // Grammar: ID=20; read/write bits=1; START (Transform)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (TransformType); next=21
            ...
            break;
        case 21:
            // Grammar: ID=21; read/write bits=2; START (Transform), END Element
            if (1 == 0)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
...
static int encode_iso2_PGPDataType(exi_bitstream_t* stream, const struct iso2_PGPDataType* PGPDataType) {
    ...
    while (!done)
    {
        ...
        {
        case 27:
            // Grammar: ID=27; read/write bits=2; START (PGPKeyID), START (PGPKeyPacket)
            if (PGPDataType->choice_1_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (PGPKeyID, base64Binary); next=28
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (PGPKeyPacket, base64Binary); next=29
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 28:
            // Grammar: ID=28; read/write bits=3; START (PGPKeyPacket), START (ANY), END Element, START (ANY)
            if (PGPDataType->choice_1_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
            ...
            else if (PGPDataType->choice_1_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ANY, base64Binary); next=30
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 29:
            // Grammar: ID=29; read/write bits=3; START (ANY), END Element, END Element, START (ANY)
            // ***** //
            //{
                // No code for unsupported generic event: ANY (index=0)
            //{
            ...
            break;
        case 30:
            // Grammar: ID=30; read/write bits=1; START (PGPKeyPacket)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 31:
            // Grammar: ID=31; read/write bits=2; START (ANY), END Element, START (ANY)
            // ***** //
            //{
                // No code for unsupported generic event: ANY (index=0)
            //{
...
static int encode_iso2_ReferenceType(exi_bitstream_t* stream, const struct iso2_ReferenceType* ReferenceType) {
    ...
    while (!done)
    {
        ...
        {
        case 32:
            // Grammar: ID=32; read/write bits=3; START (Id), START (Type), START (URI), START (Transforms), START (DigestMethod)
            if (ReferenceType->Id_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Id, NCName); next=33
            ...
            else if (ReferenceType->Transforms_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Transforms, TransformsType); next=36
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (DigestMethod, DigestMethodType); next=37
            ...
            break;
        case 33:
            // Grammar: ID=33; read/write bits=3; START (Type), START (URI), START (Transforms), START (DigestMethod)
            ...
            break;
        case 34:
            // Grammar: ID=34; read/write bits=2; START (URI), START (Transforms), START (DigestMethod)
            ...
            break;
        case 35:
            // Grammar: ID=35; read/write bits=2; START (Transforms), START (DigestMethod)
            ...
            break;
        case 36:
            // Grammar: ID=36; read/write bits=1; START (DigestMethod)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (DigestMethodType); next=37
                error = encode_iso2_DigestMethodType(stream, &ReferenceType->DigestMethod);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 37;
            ...
            break;
        case 37:
            // Grammar: ID=37; read/write bits=1; START (DigestValue)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (base64Binary); next=3
...
static int encode_iso2_RetrievalMethodType(exi_bitstream_t* stream, const struct iso2_RetrievalMethodType* RetrievalMethodType) {
    ...
    while (!done)
    {
        ...
        {
        case 38:
            // Grammar: ID=38; read/write bits=3; START (Type), START (URI), START (Transforms), END Element
            if (RetrievalMethodType->Type_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Type, anyURI); next=39
            ...
            else if (RetrievalMethodType->URI_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (URI, anyURI); next=40
            ...
            break;
        case 39:
            // Grammar: ID=39; read/write bits=2; START (URI), START (Transforms), END Element
            ...
            break;
        case 40:
            // Grammar: ID=40; read/write bits=2; START (Transforms), END Element
...
static int encode_iso2_SPKIDataType(exi_bitstream_t* stream, const struct iso2_SPKIDataType* SPKIDataType) {
    ...
    while (!done)
    {
        ...
        {
        case 41:
            // Grammar: ID=41; read/write bits=1; START (SPKISexp)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (base64Binary); next=42
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 42:
            // Grammar: ID=42; read/write bits=2; START (ANY), END Element, START (ANY)
            // ***** //
            //{
                // No code for unsupported generic event: ANY (index=0)
            //{
...
static int encode_iso2_SignatureMethodType(exi_bitstream_t* stream, const struct iso2_SignatureMethodType* SignatureMethodType) {
    ...
    while (!done)
    {
        ...
        {
        case 43:
            // Grammar: ID=43; read/write bits=1; START (Algorithm)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (anyURI); next=44
            ...
            break;
        case 44:
            // Grammar: ID=44; read/write bits=3; START (HMACOutputLength), START (ANY), END Element, START (ANY)
            if (SignatureMethodType->HMACOutputLength_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (HMACOutputLength, integer); next=45
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
...
static int encode_iso2_X509DataType(exi_bitstream_t* stream, const struct iso2_X509DataType* X509DataType) {
    ...
    while (!done)
    {
        ...
        {
        case 46:
            // Grammar: ID=46; read/write bits=3; START (X509IssuerSerial), START (X509SKI), START (X509SubjectName), START (X509Certificate), START (X509CRL), START (ANY)
...
static int encode_iso2_ObjectType(exi_bitstream_t* stream, const struct iso2_ObjectType* ObjectType) {
    ...
    while (!done)
    {
        ...
        {
        case 49:
            // Grammar: ID=49; read/write bits=3; START (Encoding), START (Id), START (MimeType), START (ANY), END Element, START (ANY)
            ...
            break;
        case 50:
            // Grammar: ID=50; read/write bits=3; START (Id), START (MimeType), START (ANY), END Element, START (ANY)
            ...
            break;
        case 51:
            // Grammar: ID=51; read/write bits=3; START (MimeType), START (ANY), END Element, START (ANY)
            ...
            break;
        case 52:
            // Grammar: ID=52; read/write bits=2; START (ANY), END Element, START (ANY)
            // ***** //
            //{
                // No code for unsupported generic event: ANY (index=0)
            //{
...
static int encode_iso2_SelectedServiceType(exi_bitstream_t* stream, const struct iso2_SelectedServiceType* SelectedServiceType) {
    ...
    while (!done)
    {
        ...
        case 53:
            ...
            break;
        case 54:
            // Grammar: ID=54; read/write bits=2; START (ParameterSetID), END Element
...
static int encode_iso2_SignedInfoType(exi_bitstream_t* stream, const struct iso2_SignedInfoType* SignedInfoType) {
    ...
    while (!done)
    {
        ...
        {
        case 62:
            // Grammar: ID=62; read/write bits=2; START (Id), START (CanonicalizationMethod)
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (CanonicalizationMethod, CanonicalizationMethodType); next=64
            ...
            break;
        case 63:
            // Grammar: ID=63; read/write bits=1; START (CanonicalizationMethod)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (CanonicalizationMethodType); next=64
                error = encode_iso2_CanonicalizationMethodType(stream, &SignedInfoType->CanonicalizationMethod);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 64;
            ...
            break;
        case 64:
            // Grammar: ID=64; read/write bits=1; START (SignatureMethod)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (SignatureMethodType); next=65
            ...
            break;
        case 65:
            // Grammar: ID=65; read/write bits=1; START (Reference)
            if (Reference_currentIndex < SignedInfoType->Reference.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ReferenceType); next=66
            ...
            break;
        case 66:
            // Grammar: ID=66; read/write bits=2; LOOP (Reference), END Element
            if (Reference_currentIndex < SignedInfoType->Reference.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (ReferenceType); next=66
                    error = encode_iso2_ReferenceType(stream, &SignedInfoType->Reference.array[Reference_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 66;
...
static int encode_iso2_SubCertificatesType(exi_bitstream_t* stream, const struct iso2_SubCertificatesType* SubCertificatesType) {
    ...
    while (!done)
    {
        ...
        case 67:
            ...
            break;
        case 68:
            // Grammar: ID=68; read/write bits=2; LOOP (Certificate), END Element
            if (Certificate_currentIndex < SubCertificatesType->Certificate.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (base64Binary); next=68
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_uint_16(stream, (uint16_t)SubCertificatesType->Certificate.array[Certificate_currentIndex].bytesLen);
...
static int encode_iso2_SupportedEnergyTransferModeType(exi_bitstream_t* stream, const struct iso2_SupportedEnergyTransferModeType* SupportedEnergyTransferModeType) {
    ...
    while (!done)
    {
        ...
        case 69:
            ...
            break;
        case 70:
            // Grammar: ID=70; read/write bits=2; LOOP (EnergyTransferMode), END Element
            if (EnergyTransferMode_currentIndex < SupportedEnergyTransferModeType->EnergyTransferMode.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (string); next=70
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        error = exi_basetypes_encoder_nbit_uint(stream, 3, SupportedEnergyTransferModeType->EnergyTransferMode.array[EnergyTransferMode_currentIndex++]);
...
static int encode_iso2_AC_EVSEStatusType(exi_bitstream_t* stream, const struct iso2_AC_EVSEStatusType* AC_EVSEStatusType) {
    ...
    while (!done)
    {
        ...
        {
        case 71:
            // Grammar: ID=71; read/write bits=1; START (NotificationMaxDelay)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedInt); next=72
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 72:
            // Grammar: ID=72; read/write bits=1; START (EVSENotification)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 73:
            // Grammar: ID=73; read/write bits=1; START (RCD)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (boolean); next=3
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgDataTypes}ChargeService; type={urn:iso:15118:2:2013:MsgDataTypes}ChargeServiceType; base type=ServiceType; content type=ELEMENT-ONLY;
//          abstract=False; final=False; derivation=extension;
...
static int encode_iso2_ChargeServiceType(exi_bitstream_t* stream, const struct iso2_ChargeServiceType* ChargeServiceType) {
    ...
    while (!done)
    {
        ...
        {
        case 74:
            // Grammar: ID=74; read/write bits=1; START (ServiceID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedShort); next=75
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 75:
            // Grammar: ID=75; read/write bits=2; START (ServiceName), START (ServiceCategory)
            if (ChargeServiceType->ServiceName_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceName, string); next=76
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceCategory, string); next=77
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 76:
            // Grammar: ID=76; read/write bits=1; START (ServiceCategory)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 77:
            // Grammar: ID=77; read/write bits=2; START (ServiceScope), START (FreeService)
            if (ChargeServiceType->ServiceScope_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceScope, string); next=78
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (FreeService, boolean); next=79
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 78:
            // Grammar: ID=78; read/write bits=1; START (FreeService)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (boolean); next=79
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_bool(stream, ChargeServiceType->FreeService);
            ...
            break;
        case 79:
            // Grammar: ID=79; read/write bits=1; START (SupportedEnergyTransferMode)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgDataTypes}ContractSignatureEncryptedPrivateKey; type={urn:iso:15118:2:2013:MsgDataTypes}ContractSignatureEncryptedPrivateKeyType; base type=privateKeyType; content type=simple;
//          abstract=False; final=False; derivation=extension;
...
static int encode_iso2_ContractSignatureEncryptedPrivateKeyType(exi_bitstream_t* stream, const struct iso2_ContractSignatureEncryptedPrivateKeyType* ContractSignatureEncryptedPrivateKeyType) {
    ...
    while (!done)
    {
        ...
        {
        case 80:
            // Grammar: ID=80; read/write bits=1; START (Id)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (NCName); next=81
            ...
            break;
        case 81:
            // Grammar: ID=81; read/write bits=1; START (CONTENT)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (base64Binary); next=3
...
static int encode_iso2_DC_EVSEStatusType(exi_bitstream_t* stream, const struct iso2_DC_EVSEStatusType* DC_EVSEStatusType) {
    ...
    while (!done)
    {
        ...
        {
        case 82:
            // Grammar: ID=82; read/write bits=1; START (NotificationMaxDelay)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedInt); next=83
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 83:
            // Grammar: ID=83; read/write bits=1; START (EVSENotification)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 84:
            // Grammar: ID=84; read/write bits=2; START (EVSEIsolationStatus), START (EVSEStatusCode)
            if (DC_EVSEStatusType->EVSEIsolationStatus_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEIsolationStatus, string); next=85
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 85:
            // Grammar: ID=85; read/write bits=1; START (EVSEStatusCode)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_DC_EVStatusType(exi_bitstream_t* stream, const struct iso2_DC_EVStatusType* DC_EVStatusType) {
    ...
    while (!done)
    {
        ...
        {
        case 86:
            // Grammar: ID=86; read/write bits=1; START (EVReady)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (boolean); next=87
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 87:
            // Grammar: ID=87; read/write bits=1; START (EVErrorCode)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 88:
            // Grammar: ID=88; read/write bits=1; START (EVRESSSOC)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_DC_EVPowerDeliveryParameterType(exi_bitstream_t* stream, const struct iso2_DC_EVPowerDeliveryParameterType* DC_EVPowerDeliveryParameterType) {
    ...
    while (!done)
    {
        ...
        {
        case 89:
            // Grammar: ID=89; read/write bits=1; START (DC_EVStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVStatusType); next=90
            ...
            break;
        case 90:
            // Grammar: ID=90; read/write bits=2; START (BulkChargingComplete), START (ChargingComplete)
            if (DC_EVPowerDeliveryParameterType->BulkChargingComplete_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (BulkChargingComplete, boolean); next=91
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 91:
            // Grammar: ID=91; read/write bits=1; START (ChargingComplete)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (boolean); next=3
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgDataTypes}DHpublickey; type={urn:iso:15118:2:2013:MsgDataTypes}DiffieHellmanPublickeyType; base type=dHpublickeyType; content type=simple;
//          abstract=False; final=False; derivation=extension;
...
static int encode_iso2_DiffieHellmanPublickeyType(exi_bitstream_t* stream, const struct iso2_DiffieHellmanPublickeyType* DiffieHellmanPublickeyType) {
    ...
    while (!done)
    {
        ...
        {
        case 92:
            // Grammar: ID=92; read/write bits=1; START (Id)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (NCName); next=93
            ...
            break;
        case 93:
            // Grammar: ID=93; read/write bits=1; START (CONTENT)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (base64Binary); next=3
...
static int encode_iso2_EVSEStatusType(exi_bitstream_t* stream, const struct iso2_EVSEStatusType* EVSEStatusType) {
    ...
    while (!done)
    {
        ...
        case 95:
            ...
            break;
        case 96:
            // Grammar: ID=96; read/write bits=1; START (AC_EVSEStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=97
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgDataTypes}EVTargetVoltage; type={urn:iso:15118:2:2013:MsgDataTypes}PhysicalValueType; base type=; content type=ELEMENT-ONLY;
//          abstract=False; final=False;
...
static int encode_iso2_PhysicalValueType(exi_bitstream_t* stream, const struct iso2_PhysicalValueType* PhysicalValueType) {
    ...
    while (!done)
    {
        ...
        {
        case 98:
            // Grammar: ID=98; read/write bits=1; START (Multiplier)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (byte); next=99
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 99:
            // Grammar: ID=99; read/write bits=1; START (Unit)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 100:
            // Grammar: ID=100; read/write bits=1; START (Value)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_ConsumptionCostType(exi_bitstream_t* stream, const struct iso2_ConsumptionCostType* ConsumptionCostType) {
    ...
    while (!done)
    {
        ...
        {
        case 101:
            // Grammar: ID=101; read/write bits=1; START (startValue)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=102
            ...
            break;
        case 102:
            // Grammar: ID=102; read/write bits=1; START (Cost)
            if (Cost_currentIndex < ConsumptionCostType->Cost.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (CostType); next=103
            ...
            break;
        case 103:
            // Grammar: ID=103; read/write bits=2; LOOP (Cost), END Element
            if (Cost_currentIndex < ConsumptionCostType->Cost.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (CostType); next=103
                    error = encode_iso2_CostType(stream, &ConsumptionCostType->Cost.array[Cost_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 103;
...
static int encode_iso2_PMaxScheduleEntryType(exi_bitstream_t* stream, const struct iso2_PMaxScheduleEntryType* PMaxScheduleEntryType) {
    ...
    while (!done)
    {
        ...
        {
        case 104:
            // Grammar: ID=104; read/write bits=2; START (RelativeTimeInterval), START (TimeInterval)
            if (PMaxScheduleEntryType->RelativeTimeInterval_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (RelativeTimeInterval, IntervalType); next=105
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Abstract element or type: START (IntervalType); next=105
            ...
            break;
        case 105:
            // Grammar: ID=105; read/write bits=1; START (PMax)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_SalesTariffEntryType(exi_bitstream_t* stream, const struct iso2_SalesTariffEntryType* SalesTariffEntryType) {
    ...
    while (!done)
    {
        ...
        {
        case 106:
            // Grammar: ID=106; read/write bits=2; START (RelativeTimeInterval), START (TimeInterval)
            if (SalesTariffEntryType->RelativeTimeInterval_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (RelativeTimeInterval, IntervalType); next=107
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Abstract element or type: START (IntervalType); next=107
            ...
            break;
        case 107:
            // Grammar: ID=107; read/write bits=2; START (EPriceLevel), START (ConsumptionCost), END Element
            ...
            break;
        case 108:
            // Grammar: ID=108; read/write bits=2; LOOP (ConsumptionCost), END Element
            if (ConsumptionCost_currentIndex < SalesTariffEntryType->ConsumptionCost.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (ConsumptionCost, ConsumptionCostType); next=108 (optional array)
                    error = encode_iso2_ConsumptionCostType(stream, &SalesTariffEntryType->ConsumptionCost.array[ConsumptionCost_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 108;
        ...
        case 109:
            ...
            break;
        case 110:
            // Grammar: ID=110; read/write bits=2; LOOP (ConsumptionCost), END Element
            if (ConsumptionCost_currentIndex < SalesTariffEntryType->ConsumptionCost.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (ConsumptionCost, ConsumptionCostType); next=110 (optional array)
                    error = encode_iso2_ConsumptionCostType(stream, &SalesTariffEntryType->ConsumptionCost.array[ConsumptionCost_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 110;
...
static int encode_iso2_PMaxScheduleType(exi_bitstream_t* stream, const struct iso2_PMaxScheduleType* PMaxScheduleType) {
    ...
    while (!done)
    {
        ...
        {
        case 111:
            // Grammar: ID=111; read/write bits=1; START (PMaxScheduleEntry)
            ...
            break;
        case 112:
            // Grammar: ID=112; read/write bits=2; LOOP (PMaxScheduleEntry), END Element
            if (PMaxScheduleEntry_currentIndex < PMaxScheduleType->PMaxScheduleEntry.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (EntryType); next=112
                    error = encode_iso2_PMaxScheduleEntryType(stream, &PMaxScheduleType->PMaxScheduleEntry.array[PMaxScheduleEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 112;
...
static int encode_iso2_ParameterType(exi_bitstream_t* stream, const struct iso2_ParameterType* ParameterType) {
    ...
    while (!done)
    {
        ...
        {
        case 113:
            // Grammar: ID=113; read/write bits=1; START (Name)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 114:
            // Grammar: ID=114; read/write bits=3; START (boolValue), START (byteValue), START (shortValue), START (intValue), START (physicalValue), START (stringValue)
...
static int encode_iso2_SalesTariffType(exi_bitstream_t* stream, const struct iso2_SalesTariffType* SalesTariffType) {
    ...
    while (!done)
    {
        ...
        {
        case 115:
            // Grammar: ID=115; read/write bits=2; START (Id), START (SalesTariffID)
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SalesTariffID, unsignedByte); next=117
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 116:
            // Grammar: ID=116; read/write bits=1; START (SalesTariffID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedByte); next=117
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_nbit_uint(stream, 8, (uint32_t)SalesTariffType->SalesTariffID - 1);
            ...
            break;
        case 117:
            // Grammar: ID=117; read/write bits=2; START (SalesTariffDescription), START (NumEPriceLevels), START (SalesTariffEntry)
            if (SalesTariffType->SalesTariffDescription_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SalesTariffDescription, string); next=119
            ...
            else if (SalesTariffType->NumEPriceLevels_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (NumEPriceLevels, unsignedShort); next=121
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 118:
            // Grammar: ID=118; read/write bits=2; LOOP (SalesTariffEntry), END Element
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (EntryType); next=118
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 118;
            ...
            break;
        case 119:
            // Grammar: ID=119; read/write bits=2; START (NumEPriceLevels), START (SalesTariffEntry)
            ...
            break;
        case 120:
            // Grammar: ID=120; read/write bits=2; LOOP (SalesTariffEntry), END Element
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (EntryType); next=120
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 120;
            ...
            break;
        case 121:
            // Grammar: ID=121; read/write bits=1; START (SalesTariffEntry)
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
            ...
            break;
        case 122:
            // Grammar: ID=122; read/write bits=2; LOOP (SalesTariffEntry), END Element
            if (SalesTariffEntry_currentIndex < SalesTariffType->SalesTariffEntry.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (EntryType); next=122
                    error = encode_iso2_SalesTariffEntryType(stream, &SalesTariffType->SalesTariffEntry.array[SalesTariffEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 122;
...
static int encode_iso2_ParameterSetType(exi_bitstream_t* stream, const struct iso2_ParameterSetType* ParameterSetType) {
    ...
    while (!done)
    {
        ...
        {
        case 123:
            // Grammar: ID=123; read/write bits=1; START (ParameterSetID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (int); next=124
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 124:
            // Grammar: ID=124; read/write bits=1; START (Parameter)
            if (Parameter_currentIndex < ParameterSetType->Parameter.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ParameterType); next=125
            ...
            break;
        case 125:
            // Grammar: ID=125; read/write bits=2; LOOP (Parameter), END Element
            if (Parameter_currentIndex < ParameterSetType->Parameter.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (ParameterType); next=125
                    error = encode_iso2_ParameterType(stream, &ParameterSetType->Parameter.array[Parameter_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 125;
...
static int encode_iso2_ProfileEntryType(exi_bitstream_t* stream, const struct iso2_ProfileEntryType* ProfileEntryType) {
    ...
    while (!done)
    {
        ...
        {
        case 126:
            // Grammar: ID=126; read/write bits=1; START (ChargingProfileEntryStart)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedLong); next=127
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 127:
            // Grammar: ID=127; read/write bits=1; START (ChargingProfileEntryMaxPower)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 128:
            // Grammar: ID=128; read/write bits=2; START (ChargingProfileEntryMaxNumberOfPhasesInUse), END Element
...
static int encode_iso2_SAScheduleTupleType(exi_bitstream_t* stream, const struct iso2_SAScheduleTupleType* SAScheduleTupleType) {
    ...
    while (!done)
    {
        ...
        {
        case 129:
            // Grammar: ID=129; read/write bits=1; START (SAScheduleTupleID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedByte); next=130
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 130:
            // Grammar: ID=130; read/write bits=1; START (PMaxSchedule)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PMaxScheduleType); next=131
            ...
            break;
        case 131:
            // Grammar: ID=131; read/write bits=2; START (SalesTariff), END Element
...
static int encode_iso2_AC_EVChargeParameterType(exi_bitstream_t* stream, const struct iso2_AC_EVChargeParameterType* AC_EVChargeParameterType) {
    ...
    while (!done)
    {
        ...
        {
        case 132:
            // Grammar: ID=132; read/write bits=2; START (DepartureTime), START (EAmount)
            if (AC_EVChargeParameterType->DepartureTime_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (DepartureTime, unsignedLong); next=133
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EAmount, PhysicalValueType); next=134
            ...
            break;
        case 133:
            // Grammar: ID=133; read/write bits=1; START (EAmount)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 134:
            // Grammar: ID=134; read/write bits=1; START (EVMaxVoltage)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=135
            ...
            break;
        case 135:
            // Grammar: ID=135; read/write bits=1; START (EVMaxCurrent)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 136:
            // Grammar: ID=136; read/write bits=1; START (EVMinCurrent)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=3
...
static int encode_iso2_AC_EVSEChargeParameterType(exi_bitstream_t* stream, const struct iso2_AC_EVSEChargeParameterType* AC_EVSEChargeParameterType) {
    ...
    while (!done)
    {
        ...
        {
        case 137:
            // Grammar: ID=137; read/write bits=1; START (AC_EVSEStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=138
            ...
            break;
        case 138:
            // Grammar: ID=138; read/write bits=1; START (EVSENominalVoltage)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 139:
            // Grammar: ID=139; read/write bits=1; START (EVSEMaxCurrent)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=3
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgDataTypes}ChargingProfile; type={urn:iso:15118:2:2013:MsgDataTypes}ChargingProfileType; base type=; content type=ELEMENT-ONLY;
//          abstract=False; final=False;
...
static int encode_iso2_ChargingProfileType(exi_bitstream_t* stream, const struct iso2_ChargingProfileType* ChargingProfileType) {
    ...
    while (!done)
    {
        ...
        {
        case 140:
            // Grammar: ID=140; read/write bits=1; START (ProfileEntry)
            ...
            break;
        case 141:
            // Grammar: ID=141; read/write bits=2; LOOP (ProfileEntry), END Element
            if (ProfileEntry_currentIndex < ChargingProfileType->ProfileEntry.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (ProfileEntryType); next=141
                    error = encode_iso2_ProfileEntryType(stream, &ChargingProfileType->ProfileEntry.array[ProfileEntry_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 141;
...
static int encode_iso2_DC_EVChargeParameterType(exi_bitstream_t* stream, const struct iso2_DC_EVChargeParameterType* DC_EVChargeParameterType) {
    ...
    while (!done)
    {
        ...
        {
        case 142:
            // Grammar: ID=142; read/write bits=2; START (DepartureTime), START (DC_EVStatus)
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (DC_EVStatus, EVStatusType); next=144
            ...
            break;
        case 143:
            // Grammar: ID=143; read/write bits=1; START (DC_EVStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVStatusType); next=144
                error = encode_iso2_DC_EVStatusType(stream, &DC_EVChargeParameterType->DC_EVStatus);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 144;
            ...
            break;
        case 144:
            // Grammar: ID=144; read/write bits=1; START (EVMaximumCurrentLimit)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 145:
            // Grammar: ID=145; read/write bits=2; START (EVMaximumPowerLimit), START (EVMaximumVoltageLimit)
            if (DC_EVChargeParameterType->EVMaximumPowerLimit_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVMaximumPowerLimit, PhysicalValueType); next=146
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVMaximumVoltageLimit, PhysicalValueType); next=147
            ...
            break;
        case 146:
            // Grammar: ID=146; read/write bits=1; START (EVMaximumVoltageLimit)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=147
                error = encode_iso2_PhysicalValueType(stream, &DC_EVChargeParameterType->EVMaximumVoltageLimit);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 147;
            ...
            break;
        case 147:
            // Grammar: ID=147; read/write bits=3; START (EVEnergyCapacity), START (EVEnergyRequest), START (FullSOC), START (BulkSOC), END Element
            if (DC_EVChargeParameterType->EVEnergyCapacity_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVEnergyCapacity, PhysicalValueType); next=148
            ...
            else if (DC_EVChargeParameterType->EVEnergyRequest_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVEnergyRequest, PhysicalValueType); next=149
            ...
            else if (DC_EVChargeParameterType->FullSOC_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (FullSOC, byte); next=150
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 148:
            // Grammar: ID=148; read/write bits=3; START (EVEnergyRequest), START (FullSOC), START (BulkSOC), END Element
            ...
            break;
        case 149:
            // Grammar: ID=149; read/write bits=2; START (FullSOC), START (BulkSOC), END Element
            ...
            break;
        case 150:
            // Grammar: ID=150; read/write bits=2; START (BulkSOC), END Element
...
static int encode_iso2_DC_EVSEChargeParameterType(exi_bitstream_t* stream, const struct iso2_DC_EVSEChargeParameterType* DC_EVSEChargeParameterType) {
    ...
    while (!done)
    {
        ...
        case 152:
            ...
            break;
        case 153:
            // Grammar: ID=153; read/write bits=1; START (EVSEMaximumPowerLimit)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_EVChargeParameterType(exi_bitstream_t* stream, const struct iso2_EVChargeParameterType* EVChargeParameterType) {
    ...
    while (!done)
    {
        ...
        {
        case 160:
            // Grammar: ID=160; read/write bits=2; START (DepartureTime), START (AC_EVChargeParameter)
            if (EVChargeParameterType->DepartureTime_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (DepartureTime, unsignedLong); next=161
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (AC_EVChargeParameter, EVChargeParameterType); next=162
            ...
            break;
        case 161:
            // Grammar: ID=161; read/write bits=1; START (AC_EVChargeParameter)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVChargeParameterType); next=162
                error = encode_iso2_AC_EVChargeParameterType(stream, &EVChargeParameterType->AC_EVChargeParameter);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 162;
            ...
            break;
        case 162:
            // Grammar: ID=162; read/write bits=1; START (DC_EVChargeParameter)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgDataTypes}ListOfRootCertificateIDs; type={urn:iso:15118:2:2013:MsgDataTypes}ListOfRootCertificateIDsType; base type=; content type=ELEMENT-ONLY;
//          abstract=False; final=False;
...
static int encode_iso2_ListOfRootCertificateIDsType(exi_bitstream_t* stream, const struct iso2_ListOfRootCertificateIDsType* ListOfRootCertificateIDsType) {
    ...
    while (!done)
    {
        ...
        {
        case 163:
            // Grammar: ID=163; read/write bits=1; START (RootCertificateID)
            if (RootCertificateID_currentIndex < ListOfRootCertificateIDsType->RootCertificateID.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (X509IssuerSerialType); next=164
            ...
            break;
        case 164:
            // Grammar: ID=164; read/write bits=2; LOOP (RootCertificateID), END Element
            if (RootCertificateID_currentIndex < ListOfRootCertificateIDsType->RootCertificateID.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (X509IssuerSerialType); next=164
                    error = encode_iso2_X509IssuerSerialType(stream, &ListOfRootCertificateIDsType->RootCertificateID.array[RootCertificateID_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 164;
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgDataTypes}MeterInfo; type={urn:iso:15118:2:2013:MsgDataTypes}MeterInfoType; base type=; content type=ELEMENT-ONLY;
//          abstract=False; final=False;
...
static int encode_iso2_MeterInfoType(exi_bitstream_t* stream, const struct iso2_MeterInfoType* MeterInfoType) {
    ...
    while (!done)
    {
        ...
        {
        case 165:
            // Grammar: ID=165; read/write bits=1; START (MeterID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 166:
            // Grammar: ID=166; read/write bits=3; START (MeterReading), START (SigMeterReading), START (MeterStatus), START (TMeter), END Element
            if (MeterInfoType->MeterReading_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MeterReading, nonNegativeInteger); next=167
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else if (MeterInfoType->SigMeterReading_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SigMeterReading, base64Binary); next=168
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else if (MeterInfoType->MeterStatus_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MeterStatus, short); next=169
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 167:
            // Grammar: ID=167; read/write bits=3; START (SigMeterReading), START (MeterStatus), START (TMeter), END Element
            ...
            break;
        case 168:
            // Grammar: ID=168; read/write bits=2; START (MeterStatus), START (TMeter), END Element
            ...
            break;
        case 169:
            // Grammar: ID=169; read/write bits=2; START (TMeter), END Element
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgDataTypes}Notification; type={urn:iso:15118:2:2013:MsgDataTypes}NotificationType; base type=; content type=ELEMENT-ONLY;
//          abstract=False; final=False;
...
static int encode_iso2_NotificationType(exi_bitstream_t* stream, const struct iso2_NotificationType* NotificationType) {
    ...
    while (!done)
    {
        ...
        {
        case 170:
            // Grammar: ID=170; read/write bits=1; START (FaultCode)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 171:
            // Grammar: ID=171; read/write bits=2; START (FaultMsg), END Element
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgDataTypes}PaymentOptionList; type={urn:iso:15118:2:2013:MsgDataTypes}PaymentOptionListType; base type=; content type=ELEMENT-ONLY;
//          abstract=False; final=False;
...
static int encode_iso2_PaymentOptionListType(exi_bitstream_t* stream, const struct iso2_PaymentOptionListType* PaymentOptionListType) {
    ...
    while (!done)
    {
        ...
        {
        case 172:
            // Grammar: ID=172; read/write bits=1; START (PaymentOption)
            ...
            break;
        case 173:
            // Grammar: ID=173; read/write bits=2; START (PaymentOption), END Element
            if (PaymentOption_currentIndex < PaymentOptionListType->PaymentOption.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgDataTypes}SAProvisioningCertificateChain; type={urn:iso:15118:2:2013:MsgDataTypes}CertificateChainType; base type=; content type=ELEMENT-ONLY;
//          abstract=False; final=False;
...
static int encode_iso2_CertificateChainType(exi_bitstream_t* stream, const struct iso2_CertificateChainType* CertificateChainType) {
    ...
    while (!done)
    {
        ...
        {
        case 174:
            // Grammar: ID=174; read/write bits=2; START (Id), START (Certificate)
            if (CertificateChainType->Id_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Id, NCName); next=175
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Certificate, base64Binary); next=176
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
        ...
        case 175:
            ...
            break;
        case 176:
            // Grammar: ID=176; read/write bits=2; START (SubCertificates), END Element
...
static int encode_iso2_SAScheduleListType(exi_bitstream_t* stream, const struct iso2_SAScheduleListType* SAScheduleListType) {
    ...
    while (!done)
    {
        ...
        {
        case 177:
            // Grammar: ID=177; read/write bits=1; START (SAScheduleTuple)
            if (SAScheduleTuple_currentIndex < SAScheduleListType->SAScheduleTuple.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SAScheduleTupleType); next=178
            ...
            break;
        case 178:
            // Grammar: ID=178; read/write bits=2; LOOP (SAScheduleTuple), END Element
            if (SAScheduleTuple_currentIndex < SAScheduleListType->SAScheduleTuple.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (SAScheduleTupleType); next=178
                    error = encode_iso2_SAScheduleTupleType(stream, &SAScheduleListType->SAScheduleTuple.array[SAScheduleTuple_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 178;
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgDataTypes}SelectedServiceList; type={urn:iso:15118:2:2013:MsgDataTypes}SelectedServiceListType; base type=; content type=ELEMENT-ONLY;
//          abstract=False; final=False;
...
static int encode_iso2_SelectedServiceListType(exi_bitstream_t* stream, const struct iso2_SelectedServiceListType* SelectedServiceListType) {
    ...
    while (!done)
    {
        ...
        {
        case 179:
            // Grammar: ID=179; read/write bits=1; START (SelectedService)
            ...
            break;
        case 180:
            // Grammar: ID=180; read/write bits=2; LOOP (SelectedService), END Element
            if (SelectedService_currentIndex < SelectedServiceListType->SelectedService.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (SelectedServiceType); next=180
                    error = encode_iso2_SelectedServiceType(stream, &SelectedServiceListType->SelectedService.array[SelectedService_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 180;
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgDataTypes}ServiceList; type={urn:iso:15118:2:2013:MsgDataTypes}ServiceListType; base type=; content type=ELEMENT-ONLY;
//          abstract=False; final=False;
...
static int encode_iso2_ServiceListType(exi_bitstream_t* stream, const struct iso2_ServiceListType* ServiceListType) {
    ...
    while (!done)
    {
        ...
        {
        case 181:
            // Grammar: ID=181; read/write bits=1; START (Service)
            if (Service_currentIndex < ServiceListType->Service.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceType); next=182
            ...
            break;
        case 182:
            // Grammar: ID=182; read/write bits=2; LOOP (Service), END Element
            if (Service_currentIndex < ServiceListType->Service.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (ServiceType); next=182
                    error = encode_iso2_ServiceType(stream, &ServiceListType->Service.array[Service_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 182;
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgDataTypes}ServiceParameterList; type={urn:iso:15118:2:2013:MsgDataTypes}ServiceParameterListType; base type=; content type=ELEMENT-ONLY;
//          abstract=False; final=False;
...
static int encode_iso2_ServiceParameterListType(exi_bitstream_t* stream, const struct iso2_ServiceParameterListType* ServiceParameterListType) {
    ...
    while (!done)
    {
        ...
        {
        case 183:
            // Grammar: ID=183; read/write bits=1; START (ParameterSet)
            ...
            break;
        case 184:
            // Grammar: ID=184; read/write bits=2; LOOP (ParameterSet), END Element
            if (ParameterSet_currentIndex < ServiceParameterListType->ParameterSet.arrayLen)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: LOOP (ParameterSetType); next=184
                    error = encode_iso2_ParameterSetType(stream, &ServiceParameterListType->ParameterSet.array[ParameterSet_currentIndex++]);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 184;
...
static int encode_iso2_SignatureType(exi_bitstream_t* stream, const struct iso2_SignatureType* SignatureType) {
    ...
    while (!done)
    {
        ...
        {
        case 185:
            // Grammar: ID=185; read/write bits=2; START (Id), START (SignedInfo)
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SignedInfo, SignedInfoType); next=187
            ...
            break;
        case 186:
            // Grammar: ID=186; read/write bits=1; START (SignedInfo)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (SignedInfoType); next=187
                error = encode_iso2_SignedInfoType(stream, &SignatureType->SignedInfo);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    grammar_id = 187;
            ...
            break;
        case 187:
            // Grammar: ID=187; read/write bits=1; START (SignatureValue)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (base64Binary); next=188
            ...
            break;
        case 188:
            // Grammar: ID=188; read/write bits=2; START (KeyInfo), START (Object), END Element
            if (SignatureType->KeyInfo_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (KeyInfo, KeyInfoType); next=190
            ...
            else if (SignatureType->Object_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Object, ObjectType); next=189
            ...
            break;
        case 189:
            // Grammar: ID=189; read/write bits=2; START (Object), END Element
            if (1 == 0)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
            ...
            break;
        case 190:
            // Grammar: ID=190; read/write bits=2; START (Object), END Element
            if (SignatureType->Object_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Object, ObjectType); next=191
                    error = encode_iso2_ObjectType(stream, &SignatureType->Object);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
                        grammar_id = 191;
            ...
            break;
        case 191:
            // Grammar: ID=191; read/write bits=2; START (Object), END Element
            if (1 == 0)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgDataTypes}eMAID; type={urn:iso:15118:2:2013:MsgDataTypes}EMAIDType; base type=eMAIDType; content type=simple;
//          abstract=False; final=False; derivation=extension;
...
static int encode_iso2_AuthorizationReqType(exi_bitstream_t* stream, const struct iso2_AuthorizationReqType* AuthorizationReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 194:
            // Grammar: ID=194; read/write bits=2; START (Id), START (GenChallenge), END Element
            if (AuthorizationReqType->Id_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Id, NCName); next=195
            ...
            break;
        case 195:
            // Grammar: ID=195; read/write bits=2; START (GenChallenge), END Element
...
static int encode_iso2_AuthorizationResType(exi_bitstream_t* stream, const struct iso2_AuthorizationResType* AuthorizationResType) {
    ...
    while (!done)
    {
        ...
        case 196:
            ...
            break;
        case 197:
            // Grammar: ID=197; read/write bits=1; START (EVSEProcessing)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (string); next=3
...
static int encode_iso2_CableCheckResType(exi_bitstream_t* stream, const struct iso2_CableCheckResType* CableCheckResType) {
    ...
    while (!done)
    {
        ...
        case 199:
            ...
            break;
        case 200:
            // Grammar: ID=200; read/write bits=1; START (DC_EVSEStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=201
            ...
            break;
        case 201:
            // Grammar: ID=201; read/write bits=1; START (EVSEProcessing)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (string); next=3
...
static int encode_iso2_CertificateInstallationReqType(exi_bitstream_t* stream, const struct iso2_CertificateInstallationReqType* CertificateInstallationReqType) {
    ...
    while (!done)
    {
        ...
        case 202:
            ...
            break;
        case 203:
            // Grammar: ID=203; read/write bits=1; START (OEMProvisioningCert)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (base64Binary); next=204
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 204:
            // Grammar: ID=204; read/write bits=1; START (ListOfRootCertificateIDs)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_CertificateInstallationResType(exi_bitstream_t* stream, const struct iso2_CertificateInstallationResType* CertificateInstallationResType) {
    ...
    while (!done)
    {
        ...
        {
        case 205:
            // Grammar: ID=205; read/write bits=1; START (ResponseCode)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (string); next=206
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 206:
            // Grammar: ID=206; read/write bits=1; START (SAProvisioningCertificateChain)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (CertificateChainType); next=207
            ...
            break;
        case 207:
            // Grammar: ID=207; read/write bits=1; START (ContractSignatureCertChain)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (CertificateChainType); next=208
            ...
            break;
        case 208:
            // Grammar: ID=208; read/write bits=1; START (ContractSignatureEncryptedPrivateKey)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (privateKeyType); next=209
            ...
            break;
        case 209:
            // Grammar: ID=209; read/write bits=1; START (DHpublickey)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (dHpublickeyType); next=210
            ...
            break;
        case 210:
            // Grammar: ID=210; read/write bits=1; START (eMAID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_CertificateUpdateReqType(exi_bitstream_t* stream, const struct iso2_CertificateUpdateReqType* CertificateUpdateReqType) {
    ...
    while (!done)
    {
        ...
        case 211:
            ...
            break;
        case 212:
            // Grammar: ID=212; read/write bits=1; START (ContractSignatureCertChain)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (CertificateChainType); next=213
            ...
            break;
        case 213:
            // Grammar: ID=213; read/write bits=1; START (eMAID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 214:
            // Grammar: ID=214; read/write bits=1; START (ListOfRootCertificateIDs)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (ListOfRootCertificateIDsType); next=3
...
static int encode_iso2_CertificateUpdateResType(exi_bitstream_t* stream, const struct iso2_CertificateUpdateResType* CertificateUpdateResType) {
    ...
    while (!done)
    {
        ...
        case 215:
            ...
            break;
        case 216:
            // Grammar: ID=216; read/write bits=1; START (SAProvisioningCertificateChain)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (CertificateChainType); next=217
            ...
            break;
        case 217:
            // Grammar: ID=217; read/write bits=1; START (ContractSignatureCertChain)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 218:
            // Grammar: ID=218; read/write bits=1; START (ContractSignatureEncryptedPrivateKey)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (privateKeyType); next=219
            ...
            break;
        case 219:
            // Grammar: ID=219; read/write bits=1; START (DHpublickey)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (dHpublickeyType); next=220
            ...
            break;
        case 220:
            // Grammar: ID=220; read/write bits=1; START (eMAID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (eMAIDType); next=221
            ...
            break;
        case 221:
            // Grammar: ID=221; read/write bits=2; START (RetryCounter), END Element
...
static int encode_iso2_ChargeParameterDiscoveryReqType(exi_bitstream_t* stream, const struct iso2_ChargeParameterDiscoveryReqType* ChargeParameterDiscoveryReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 222:
            // Grammar: ID=222; read/write bits=2; START (MaxEntriesSAScheduleTuple), START (RequestedEnergyTransferMode)
            if (ChargeParameterDiscoveryReqType->MaxEntriesSAScheduleTuple_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MaxEntriesSAScheduleTuple, unsignedInt); next=223
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (RequestedEnergyTransferMode, string); next=224
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 223:
            // Grammar: ID=223; read/write bits=1; START (RequestedEnergyTransferMode)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 224:
            // Grammar: ID=224; read/write bits=2; START (AC_EVChargeParameter), START (DC_EVChargeParameter), START (EVChargeParameter)
...
static int encode_iso2_ChargeParameterDiscoveryResType(exi_bitstream_t* stream, const struct iso2_ChargeParameterDiscoveryResType* ChargeParameterDiscoveryResType) {
    ...
    while (!done)
    {
        ...
        case 225:
            ...
            break;
        case 226:
            // Grammar: ID=226; read/write bits=1; START (EVSEProcessing)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 227:
            // Grammar: ID=227; read/write bits=3; START (SAScheduleList), START (SASchedules), START (AC_EVSEChargeParameter), START (DC_EVSEChargeParameter), START (EVSEChargeParameter)
            if (ChargeParameterDiscoveryResType->SAScheduleList_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SAScheduleList, SASchedulesType); next=228
            ...
            else if (ChargeParameterDiscoveryResType->SASchedules_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Abstract element or type: START (SASchedulesType); next=228
            ...
            break;
        case 228:
            // Grammar: ID=228; read/write bits=2; START (AC_EVSEChargeParameter), START (DC_EVSEChargeParameter), START (EVSEChargeParameter)
...
static int encode_iso2_ChargingStatusResType(exi_bitstream_t* stream, const struct iso2_ChargingStatusResType* ChargingStatusResType) {
    ...
    while (!done)
    {
        ...
        case 230:
            ...
            break;
        case 231:
            // Grammar: ID=231; read/write bits=1; START (SAScheduleTupleID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedByte); next=232
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 232:
            // Grammar: ID=232; read/write bits=3; START (EVSEMaxCurrent), START (MeterInfo), START (ReceiptRequired), START (AC_EVSEStatus)
            if (ChargingStatusResType->EVSEMaxCurrent_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEMaxCurrent, PhysicalValueType); next=233
            ...
            else if (ChargingStatusResType->MeterInfo_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MeterInfo, MeterInfoType); next=234
            ...
            else if (ChargingStatusResType->ReceiptRequired_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ReceiptRequired, boolean); next=235
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 233:
            // Grammar: ID=233; read/write bits=2; START (MeterInfo), START (ReceiptRequired), START (AC_EVSEStatus)
            ...
            break;
        case 234:
            // Grammar: ID=234; read/write bits=2; START (ReceiptRequired), START (AC_EVSEStatus)
            ...
            break;
        case 235:
            // Grammar: ID=235; read/write bits=1; START (AC_EVSEStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=3
...
static int encode_iso2_CurrentDemandReqType(exi_bitstream_t* stream, const struct iso2_CurrentDemandReqType* CurrentDemandReqType) {
    ...
    while (!done)
    {
        ...
        case 236:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVStatusType); next=237
            ...
            break;
        case 237:
            // Grammar: ID=237; read/write bits=1; START (EVTargetCurrent)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 238:
            // Grammar: ID=238; read/write bits=3; START (EVMaximumVoltageLimit), START (EVMaximumCurrentLimit), START (EVMaximumPowerLimit), START (BulkChargingComplete), START (ChargingComplete)
            if (CurrentDemandReqType->EVMaximumVoltageLimit_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVMaximumVoltageLimit, PhysicalValueType); next=239
            ...
            else if (CurrentDemandReqType->EVMaximumCurrentLimit_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVMaximumCurrentLimit, PhysicalValueType); next=240
            ...
            else if (CurrentDemandReqType->EVMaximumPowerLimit_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVMaximumPowerLimit, PhysicalValueType); next=241
            ...
            else if (CurrentDemandReqType->BulkChargingComplete_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (BulkChargingComplete, boolean); next=242
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ChargingComplete, boolean); next=243
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 239:
            // Grammar: ID=239; read/write bits=3; START (EVMaximumCurrentLimit), START (EVMaximumPowerLimit), START (BulkChargingComplete), START (ChargingComplete)
            ...
            break;
        case 240:
            // Grammar: ID=240; read/write bits=2; START (EVMaximumPowerLimit), START (BulkChargingComplete), START (ChargingComplete)
            ...
            break;
        case 241:
            // Grammar: ID=241; read/write bits=2; START (BulkChargingComplete), START (ChargingComplete)
            ...
            break;
        case 242:
            // Grammar: ID=242; read/write bits=1; START (ChargingComplete)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (boolean); next=243
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_bool(stream, CurrentDemandReqType->ChargingComplete);
            ...
            break;
        case 243:
            // Grammar: ID=243; read/write bits=2; START (RemainingTimeToFullSoC), START (RemainingTimeToBulkSoC), START (EVTargetVoltage)
            if (CurrentDemandReqType->RemainingTimeToFullSoC_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (RemainingTimeToFullSoC, PhysicalValueType); next=244
            ...
            else if (CurrentDemandReqType->RemainingTimeToBulkSoC_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (RemainingTimeToBulkSoC, PhysicalValueType); next=245
            ...
            break;
        case 244:
            // Grammar: ID=244; read/write bits=2; START (RemainingTimeToBulkSoC), START (EVTargetVoltage)
            ...
            break;
        case 245:
            // Grammar: ID=245; read/write bits=1; START (EVTargetVoltage)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=3
...
static int encode_iso2_CurrentDemandResType(exi_bitstream_t* stream, const struct iso2_CurrentDemandResType* CurrentDemandResType) {
    ...
    while (!done)
    {
        ...
        case 246:
            ...
            break;
        case 247:
            // Grammar: ID=247; read/write bits=1; START (DC_EVSEStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (EVSEStatusType); next=248
            ...
            break;
        case 248:
            // Grammar: ID=248; read/write bits=1; START (EVSEPresentVoltage)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 249:
            // Grammar: ID=249; read/write bits=1; START (EVSEPresentCurrent)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=250
            ...
            break;
        case 250:
            // Grammar: ID=250; read/write bits=1; START (EVSECurrentLimitAchieved)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 251:
            // Grammar: ID=251; read/write bits=1; START (EVSEVoltageLimitAchieved)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
        ...
        case 252:
            ...
            break;
        case 253:
            // Grammar: ID=253; read/write bits=3; START (EVSEMaximumVoltageLimit), START (EVSEMaximumCurrentLimit), START (EVSEMaximumPowerLimit), START (EVSEID)
            if (CurrentDemandResType->EVSEMaximumVoltageLimit_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEMaximumVoltageLimit, PhysicalValueType); next=254
            ...
            else if (CurrentDemandResType->EVSEMaximumCurrentLimit_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEMaximumCurrentLimit, PhysicalValueType); next=255
            ...
            else if (CurrentDemandResType->EVSEMaximumPowerLimit_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEMaximumPowerLimit, PhysicalValueType); next=256
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (EVSEID, string); next=257
            ...
            break;
        case 254:
            // Grammar: ID=254; read/write bits=2; START (EVSEMaximumCurrentLimit), START (EVSEMaximumPowerLimit), START (EVSEID)
            ...
            break;
        case 255:
            // Grammar: ID=255; read/write bits=2; START (EVSEMaximumPowerLimit), START (EVSEID)
        ...
        case 257:
            ...
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedByte); next=258
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 258:
            // Grammar: ID=258; read/write bits=2; START (MeterInfo), START (ReceiptRequired), END Element
            if (CurrentDemandResType->MeterInfo_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MeterInfo, MeterInfoType); next=259
            ...
            break;
        case 259:
            // Grammar: ID=259; read/write bits=2; START (ReceiptRequired), END Element
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgHeader}Header; type={urn:iso:15118:2:2013:MsgHeader}MessageHeaderType; base type=; content type=ELEMENT-ONLY;
//          abstract=False; final=False;
...
static int encode_iso2_MessageHeaderType(exi_bitstream_t* stream, const struct iso2_MessageHeaderType* MessageHeaderType) {
    ...
    while (!done)
    {
        ...
        {
        case 260:
            // Grammar: ID=260; read/write bits=1; START (SessionID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (hexBinary); next=261
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 261:
            // Grammar: ID=261; read/write bits=2; START (Notification), START (Signature), END Element
            if (MessageHeaderType->Notification_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Notification, NotificationType); next=262
            ...
            break;
        case 262:
            // Grammar: ID=262; read/write bits=2; START (Signature), END Element
...
static int encode_iso2_MeteringReceiptReqType(exi_bitstream_t* stream, const struct iso2_MeteringReceiptReqType* MeteringReceiptReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 263:
            // Grammar: ID=263; read/write bits=2; START (Id), START (SessionID)
            if (MeteringReceiptReqType->Id_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (Id, NCName); next=264
            ...
            else
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SessionID, hexBinary); next=265
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 264:
            // Grammar: ID=264; read/write bits=1; START (SessionID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (hexBinary); next=265
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    error = exi_basetypes_encoder_uint_16(stream, (uint16_t)MeteringReceiptReqType->SessionID.bytesLen);
            ...
            break;
        case 265:
            // Grammar: ID=265; read/write bits=2; START (SAScheduleTupleID), START (MeterInfo)
            if (MeteringReceiptReqType->SAScheduleTupleID_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SAScheduleTupleID, unsignedByte); next=266
                    error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                    if (error == EXI_ERROR__NO_ERROR)
                    {
            ...
            break;
        case 266:
            // Grammar: ID=266; read/write bits=1; START (MeterInfo)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_MeteringReceiptResType(exi_bitstream_t* stream, const struct iso2_MeteringReceiptResType* MeteringReceiptResType) {
    ...
    while (!done)
    {
        ...
        case 267:
            ...
            break;
        case 268:
            // Grammar: ID=268; read/write bits=2; START (AC_EVSEStatus), START (DC_EVSEStatus), START (EVSEStatus)
...
static int encode_iso2_PaymentDetailsReqType(exi_bitstream_t* stream, const struct iso2_PaymentDetailsReqType* PaymentDetailsReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 269:
            // Grammar: ID=269; read/write bits=1; START (eMAID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_PaymentDetailsResType(exi_bitstream_t* stream, const struct iso2_PaymentDetailsResType* PaymentDetailsResType) {
    ...
    while (!done)
    {
        ...
        case 271:
            ...
            break;
        case 272:
            // Grammar: ID=272; read/write bits=1; START (GenChallenge)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 273:
            // Grammar: ID=273; read/write bits=1; START (EVSETimeStamp)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_PaymentServiceSelectionReqType(exi_bitstream_t* stream, const struct iso2_PaymentServiceSelectionReqType* PaymentServiceSelectionReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 274:
            // Grammar: ID=274; read/write bits=1; START (SelectedPaymentOption)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 275:
            // Grammar: ID=275; read/write bits=1; START (SelectedServiceList)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_PowerDeliveryReqType(exi_bitstream_t* stream, const struct iso2_PowerDeliveryReqType* PowerDeliveryReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 277:
            // Grammar: ID=277; read/write bits=1; START (ChargeProgress)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 278:
            // Grammar: ID=278; read/write bits=1; START (SAScheduleTupleID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (unsignedByte); next=279
                error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
            ...
            break;
        case 279:
            // Grammar: ID=279; read/write bits=3; START (ChargingProfile), START (DC_EVPowerDeliveryParameter), START (EVPowerDeliveryParameter), END Element
            if (PowerDeliveryReqType->ChargingProfile_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 3, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ChargingProfile, ChargingProfileType); next=280
            ...
            break;
        case 280:
            // Grammar: ID=280; read/write bits=2; START (DC_EVPowerDeliveryParameter), START (EVPowerDeliveryParameter), END Element
...
static int encode_iso2_PowerDeliveryResType(exi_bitstream_t* stream, const struct iso2_PowerDeliveryResType* PowerDeliveryResType) {
    ...
    while (!done)
    {
        ...
        case 281:
            ...
            break;
        case 282:
            // Grammar: ID=282; read/write bits=2; START (AC_EVSEStatus), START (DC_EVSEStatus), START (EVSEStatus)
...
static int encode_iso2_PreChargeReqType(exi_bitstream_t* stream, const struct iso2_PreChargeReqType* PreChargeReqType) {
    ...
    while (!done)
    {
        ...
        case 283:
            ...
            break;
        case 284:
            // Grammar: ID=284; read/write bits=1; START (EVTargetVoltage)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=285
            ...
            break;
        case 285:
            // Grammar: ID=285; read/write bits=1; START (EVTargetCurrent)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=3
...
static int encode_iso2_ServiceDetailReqType(exi_bitstream_t* stream, const struct iso2_ServiceDetailReqType* ServiceDetailReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 289:
            // Grammar: ID=289; read/write bits=1; START (ServiceID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_ServiceDetailResType(exi_bitstream_t* stream, const struct iso2_ServiceDetailResType* ServiceDetailResType) {
    ...
    while (!done)
    {
        ...
        case 290:
            ...
            break;
        case 291:
            // Grammar: ID=291; read/write bits=1; START (ServiceID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 292:
            // Grammar: ID=292; read/write bits=2; START (ServiceParameterList), END Element
...
static int encode_iso2_ServiceDiscoveryReqType(exi_bitstream_t* stream, const struct iso2_ServiceDiscoveryReqType* ServiceDiscoveryReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 293:
            // Grammar: ID=293; read/write bits=2; START (ServiceScope), START (ServiceCategory), END Element
            if (ServiceDiscoveryReqType->ServiceScope_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 2, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceScope, string); next=294
            ...
            break;
        case 294:
            // Grammar: ID=294; read/write bits=2; START (ServiceCategory), END Element
...
static int encode_iso2_ServiceDiscoveryResType(exi_bitstream_t* stream, const struct iso2_ServiceDiscoveryResType* ServiceDiscoveryResType) {
    ...
    while (!done)
    {
        ...
        case 295:
            ...
            break;
        case 296:
            // Grammar: ID=296; read/write bits=1; START (PaymentOptionList)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PaymentOptionListType); next=297
            ...
            break;
        case 297:
            // Grammar: ID=297; read/write bits=1; START (ChargeService)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (ServiceType); next=298
            ...
            break;
        case 298:
            // Grammar: ID=298; read/write bits=2; START (ServiceList), END Element
...
static int encode_iso2_SessionSetupReqType(exi_bitstream_t* stream, const struct iso2_SessionSetupReqType* SessionSetupReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 299:
            // Grammar: ID=299; read/write bits=1; START (EVCCID)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
...
static int encode_iso2_SessionSetupResType(exi_bitstream_t* stream, const struct iso2_SessionSetupResType* SessionSetupResType) {
    ...
    while (!done)
    {
        ...
        case 301:
            ...
            break;
        case 302:
            // Grammar: ID=302; read/write bits=2; START (EVSETimeStamp), END Element
...
static int encode_iso2_SessionStopReqType(exi_bitstream_t* stream, const struct iso2_SessionStopReqType* SessionStopReqType) {
    ...
    while (!done)
    {
        ...
        {
        case 303:
            // Grammar: ID=303; read/write bits=1; START (ChargingSession)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (string); next=3
...
static int encode_iso2_WeldingDetectionResType(exi_bitstream_t* stream, const struct iso2_WeldingDetectionResType* WeldingDetectionResType) {
    ...
    while (!done)
    {
        ...
        case 306:
            ...
            break;
        case 307:
            // Grammar: ID=307; read/write bits=1; START (DC_EVSEStatus)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
            ...
            break;
        case 308:
            // Grammar: ID=308; read/write bits=1; START (EVSEPresentVoltage)
            error = exi_basetypes_encoder_nbit_uint(stream, 1, 0);
            if (error == EXI_ERROR__NO_ERROR)
            {
                // Event: START (PhysicalValueType); next=3
...
// Element: definition=complex; name={urn:iso:15118:2:2013:MsgBody}Body; type={urn:iso:15118:2:2013:MsgBody}BodyType; base type=; content type=ELEMENT-ONLY;
//          abstract=False; final=False;
...
static int encode_iso2_BodyType(exi_bitstream_t* stream, const struct iso2_BodyType* BodyType) {
    ...
    while (!done)
    {
        ...
        {
        case 309:
            // Grammar: ID=309; read/write bits=6; START (AuthorizationReq), START (AuthorizationRes), START (BodyElement), START (CableCheckReq), START (CableCheckRes), START (CertificateInstallationReq), START (CertificateInstallationRes), START (CertificateUpdateReq), START (CertificateUpdateRes), START (ChargeParameterDiscoveryReq), START (ChargeParameterDiscoveryRes), START (ChargingStatusReq), START (ChargingStatusRes), START (CurrentDemandReq), START (CurrentDemandRes), START (MeteringReceiptReq), START (MeteringReceiptRes), START (PaymentDetailsReq), START (PaymentDetailsRes), START (PaymentServiceSelectionReq), START (PaymentServiceSelectionRes), START (PowerDeliveryReq), START (PowerDeliveryRes), START (PreChargeReq), START (PreChargeRes), START (ServiceDetailReq), START (ServiceDetailRes), START (ServiceDiscoveryReq), START (ServiceDiscoveryRes), START (SessionSetupReq), START (SessionSetupRes), START (SessionStopReq), START (SessionStopRes), START (WeldingDetectionReq), START (WeldingDetectionRes), END Element
            if (BodyType->AuthorizationReq_isUsed == 1u)
            {
                error = exi_basetypes_encoder_nbit_uint(stream, 6, 0);
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (AuthorizationReq, BodyBaseType); next=3
            ...
            else if (BodyType->AuthorizationRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (AuthorizationRes, BodyBaseType); next=3
            ...
            else if (BodyType->BodyElement_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Abstract element or type: START (BodyBaseType); next=3
            ...
            else if (BodyType->CableCheckReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (CableCheckReq, BodyBaseType); next=3
            ...
            else if (BodyType->CableCheckRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (CableCheckRes, BodyBaseType); next=3
            ...
            else if (BodyType->CertificateInstallationReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (CertificateInstallationReq, BodyBaseType); next=3
            ...
            else if (BodyType->CertificateInstallationRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (CertificateInstallationRes, BodyBaseType); next=3
            ...
            else if (BodyType->CertificateUpdateReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (CertificateUpdateReq, BodyBaseType); next=3
            ...
            else if (BodyType->CertificateUpdateRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (CertificateUpdateRes, BodyBaseType); next=3
            ...
            else if (BodyType->ChargeParameterDiscoveryReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ChargeParameterDiscoveryReq, BodyBaseType); next=3
            ...
            else if (BodyType->ChargeParameterDiscoveryRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ChargeParameterDiscoveryRes, BodyBaseType); next=3
            ...
            else if (BodyType->ChargingStatusReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ChargingStatusReq, BodyBaseType); next=3
            ...
            else if (BodyType->ChargingStatusRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ChargingStatusRes, BodyBaseType); next=3
            ...
            else if (BodyType->CurrentDemandReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (CurrentDemandReq, BodyBaseType); next=3
            ...
            else if (BodyType->CurrentDemandRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (CurrentDemandRes, BodyBaseType); next=3
            ...
            else if (BodyType->MeteringReceiptReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MeteringReceiptReq, BodyBaseType); next=3
            ...
            else if (BodyType->MeteringReceiptRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (MeteringReceiptRes, BodyBaseType); next=3
            ...
            else if (BodyType->PaymentDetailsReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (PaymentDetailsReq, BodyBaseType); next=3
            ...
            else if (BodyType->PaymentDetailsRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (PaymentDetailsRes, BodyBaseType); next=3
            ...
            else if (BodyType->PaymentServiceSelectionReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (PaymentServiceSelectionReq, BodyBaseType); next=3
            ...
            else if (BodyType->PaymentServiceSelectionRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (PaymentServiceSelectionRes, BodyBaseType); next=3
            ...
            else if (BodyType->PowerDeliveryReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (PowerDeliveryReq, BodyBaseType); next=3
            ...
            else if (BodyType->PowerDeliveryRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (PowerDeliveryRes, BodyBaseType); next=3
            ...
            else if (BodyType->PreChargeReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (PreChargeReq, BodyBaseType); next=3
            ...
            else if (BodyType->PreChargeRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (PreChargeRes, BodyBaseType); next=3
            ...
            else if (BodyType->ServiceDetailReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceDetailReq, BodyBaseType); next=3
            ...
            else if (BodyType->ServiceDetailRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceDetailRes, BodyBaseType); next=3
            ...
            else if (BodyType->ServiceDiscoveryReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceDiscoveryReq, BodyBaseType); next=3
            ...
            else if (BodyType->ServiceDiscoveryRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (ServiceDiscoveryRes, BodyBaseType); next=3
            ...
            else if (BodyType->SessionSetupReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SessionSetupReq, BodyBaseType); next=3
            ...
            else if (BodyType->SessionSetupRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SessionSetupRes, BodyBaseType); next=3
            ...
            else if (BodyType->SessionStopReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SessionStopReq, BodyBaseType); next=3
            ...
            else if (BodyType->SessionStopRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (SessionStopRes, BodyBaseType); next=3
            ...
            else if (BodyType->WeldingDetectionReq_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (WeldingDetectionReq, BodyBaseType); next=3
            ...
            else if (BodyType->WeldingDetectionRes_isUsed == 1u)
            {
                ...
                if (error == EXI_ERROR__NO_ERROR)
                {
                    // Event: START (WeldingDetectionRes, BodyBaseType); next=3
